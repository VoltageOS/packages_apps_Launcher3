...
import static com.android.launcher3.taskbar.TaskbarManagerImpl.GESTURE_NAVBAR_HEIGHT_MODE;
...
public class StashedHandleViewController implements TaskbarControllers.LoggableTaskbarController,
    ...
    public void init(TaskbarControllers controllers) {
        ...
        int handleHeightMode = SettingsCache.INSTANCE.get(mActivity).getIntValue(GESTURE_NAVBAR_HEIGHT_MODE, 3);
