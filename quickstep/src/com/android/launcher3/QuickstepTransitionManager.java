...
public class QuickstepTransitionManager implements OnDeviceProfileChangeListener {
    ...
    private ValueAnimator getBackgroundBlurAnimator() {
        boolean allowBlurringLauncher = mLauncher.getStateManager().getState() != OVERVIEW
                && BlurUtils.supportsBlursOnWindows();

        ValueAnimator backgroundRadiusAnim =
                ValueAnimator.ofFloat(0f, BACKGROUND_APP.getDepth(mLauncher));
        backgroundRadiusAnim.setDuration(APP_LAUNCH_DURATION);
        ...
        if (allowBlurringLauncher) {
            ...
            if (parentSurface != null) {
                ...
                backgroundRadiusAnim.addUpdateListener(animation -> {
                    ...
                    float maxBlurRadius = LauncherPrefs.BLUR_DEPTH.get(mLauncher);
