...
constructor(@ApplicationContext private val encryptedContext: Context) {
    ...
    companion object {
        ...
        @JvmField val DOCK_RECENTS_FILL = backedUpItem("pref_dock_recents_fill", false)
        @JvmField val DOCK_RECENTS_SHOW_MOST_USED = backedUpItem("pref_dock_recents_show_most_used", false)
        ...
        @JvmField val RECENTS_APPLOCK_BLUR = backedUpItem("pref_recents_applock_blur", true)
        @JvmField val RECENTS_CHIPS = backedUpItem("pref_recents_chips", false)
