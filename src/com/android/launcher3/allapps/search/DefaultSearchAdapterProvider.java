...
public class DefaultSearchAdapterProvider extends SearchAdapterProvider<ActivityContext> {
    ...
    public boolean performGoogleSearch(View view, String query) {
        String pkgName = Utilities.useWidgetQsb(view.getContext())
                ? QsbContainerView.getWidgetSearchWidgetPackageName(view.getContext())
                : Utilities.hasGoogleQsb(view.getContext()) ? Utilities.GSA_PACKAGE
                : QsbContainerView.getSearchWidgetPackageName(view.getContext());
